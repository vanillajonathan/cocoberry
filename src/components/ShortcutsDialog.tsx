                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <div className="container-fluid">
                                <div className="row">
                                    <div className="col-6"><kbd><kbd>Shift</kbd> + <kbd>Alt</kbd> + <kbd>N</kbd></kbd></div>
                                    <div className="col-6">Add new experience</div>
                                    <div className="col-6"><kbd><kbd>Shift</kbd> + <kbd>Alt</kbd> + <kbd>S</kbd></kbd></div>
                                    <div className="col-6">Search</div>
                                    <div className="col-6"><kbd><kbd>Shift</kbd> + <kbd>Alt</kbd> + <kbd>P</kbd></kbd></div>
                                    <div className="col-6">Preferences</div>
                                    <div className="col-6"><kbd><kbd>Shift</kbd> + <kbd>Alt</kbd> + <kbd>R</kbd></kbd></div>
